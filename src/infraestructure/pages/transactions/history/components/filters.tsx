  ...
  popup: {
    ...
    footer: {
      ...
      button: {
        ...
        clear:
          'border-[1px] border-borderPrimary-100 text-text-primary hover:bg-borderPrimary-100',
      },
    },
  },
  views: {
    days: {
      header: {
        ...
        title:
          'h-6 text-center text-sm font-medium leading-6 text-text-primary bg-secondary-100',
      },
      items: {
